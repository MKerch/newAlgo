...
public class PrimeDates {
    ...
    public static void main(String[] args) {
        month = new int[15];
//        System.out.println(findPrimeDates(2, 8, 2025, 04, 9, 2025));
//        System.out.println(findPrimeDates(25, 6, 2365, 7, 9, 8847));
        System.out.println(findPrimeDates(10,12,7733, 22,1,7937));
    }
